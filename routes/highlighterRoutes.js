...
const { createHighlighter, getArticleHighlighter, deleteArticleHighlighter, getArticleData, updateArticleHighlighter, getProxyData, createNewHighlighter, getNewArticleHighlighter, updateArticleData, updateNewHighlighter, deleteNewArticleHighlighter } = require("../controllers/highlighterController");
